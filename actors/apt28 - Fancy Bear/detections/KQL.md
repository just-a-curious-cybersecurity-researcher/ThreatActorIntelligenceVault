...
**Reviewed:** 2026-09-15. Nine retained Microsoft queries and 24 locally authored hunts are visible below. Local H01–H24 have matching identifiers in Splunk. All local hunts are behavioral or artifact hypotheses, not vendor-published rules or actor attribution. Source provenance is centralized in the actor bibliography.
...
### 2.1 GooseEgg: payload execution and scheduled tasks
...
### 2.2 GooseEgg: COM server registration
...
### 2.3 GooseEgg: protocol registration
...
### 3.1 GooseEgg: driver-store JavaScript modification
...
### 4.1 Exchange: NTLM-authenticated EWS activity
...
### 4.2 Cloud mailbox search and item access
...
## 5. Campaign Artifact Hunts

### 5.1 GooseEgg: staged scripts and payload files
...
## 6. Local Procedure and Campaign Hunts
