...
**Reviewed:** 2026-09-15. Four retained Splunk Security Content searches and 24 locally authored hunts are visible below. Local H01–H24 correspond to KQL hunts; differences in sensor coverage are stated beside each query. Source provenance is centralized in the actor bibliography.
...
## 1. Published Outlook Persistence Searches

Copy the searches below into Splunk with the Endpoint CIM model and referenced macros available.

### 1.1 Outlook macro security modified

**Search name:** `windows_outlook_macro_security_modified`. Preserve the publisher macros and tune their filters to local administration.

**Telemetry:** Endpoint.Registry CIM; registry changes such as Sysmon Event 13.

**Review / tuning:** Requires publisher macros and CIM field mapping. Baseline approved Outlook policies and macros; correlate with the creating process. Compatibility corrections and upstream limits are documented below.
...
### 1.2 Outlook macro created by suspicious process

**Search name:** `windows_outlook_macro_created_by_suspicious_process`. Preserve the publisher macros and tune their filters to local administration.
...
### 1.3 Outlook loadmacroprovideronboot persistence

**Search name:** `windows_outlook_loadmacroprovideronboot_persistence`. Preserve the publisher macros and tune their filters to local administration.
...
### 1.4 Outlook dialogs disabled from unusual process

**Search name:** `windows_outlook_dialogs_disabled_from_unusual_process`. Preserve the publisher macros and tune their filters to local administration.
...
## 2. Local Procedure and Campaign Hunts

### H01. Office spawning a script interpreter or proxy execution binary

**Origin:** locally authored hunt. **Reviewed:** 2026-09-15.
...
### H02. Outlook outbound SMB to a public IPv4 address
...
### H03. HEADLACE-style headless browser launched by a script
...
### H04. Script command renaming an image or stylesheet into a batch file
...
### H05. GooseEgg-associated scheduled task
...
### H06. GooseEgg-associated COM registration
...
### H07. GooseEgg-associated protocol handler
...
### H08. GooseEgg copied printer constraint file in ProgramData
...
### H09. Outlook macro project written by another process
...
### H10. Outlook macro security lowered
...
### H11. Outlook macro provider enabled at startup
...
### H12. Outlook dialog settings changed by another process
...
### H13. OneDrive loading SSPICLI from a user or staging directory
...
### H14. Outlook spawning a command or script interpreter
...
### H15. Browser-secret collection terms in PowerShell
...
### H16. Credential prompt with password extraction and file output
...
### H17. Registry hive export associated with credential collection
...
### H18. Remote-service command execution through PSEXESVC
...
### H19. Neusploit staging artifact creation
...
### H20. Mail protocol connection from a scripting process
...
### H21. Native discovery command burst
...
### H22. Connections to the retained router-campaign IP inventory
...
### H23. Retained malicious sample hashes
...
### H24. Scripting or browser context contacting webhook service
